...
class Album {
  ...
  factory Album.fromJson(Map<String, dynamic> json,
    ...
    if (json["location"] == [0, 0] || json["location"] == null) {
...
Future<Album> createAlbum(List<String> coords, String tripId, String shapeId,
  ...
  final response = await http.post(
    Uri.parse("http://$serverAddress:$port/map-match"),
...
Future<ShapeAlbum> createShapeAlbum(
  ...
  final response = await http.post(
    Uri.parse("http://$serverAddress:$port/shapes"),
    headers: <String, String> {
      "Content-Type": 'application/json',
    },
    body: jsonEncode(<String, dynamic> {
...
Future<ChatAlbum> createChatAlbum(
  ...
  if (justFetchInfo) {
    response = await http.post(
      Uri.parse("http://$serverAddress:$port/chat"),
      headers: <String, String>{
        "Content-Type": 'application/json',
      },
      body: jsonEncode(<String, dynamic>{
